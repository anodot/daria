export STREAMSETS_USERNAME="admin" STREAMSETS_PASSWORD="admin" STREAMSETS_URL="http://localhost:18630" \
    LOG_FILE_PATH="agent.log" ANODOT_API_URL="http://localhost:8080" \
    GIT_SHA1=local-build VALIDATION_ENABLED="true"

# Copy this to Pycharm debugger config
# STREAMSETS_USERNAME=admin;STREAMSETS_PASSWORD=admin;STREAMSETS_URL=http://localhost:18630;LOG_FILE_PATH=agent.log;ANODOT_API_URL=http://localhost:8080;GIT_SHA1=local-build;VALIDATION_ENABLED=true
