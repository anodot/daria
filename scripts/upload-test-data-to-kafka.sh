...
docker exec agent-kafka bash -c "kafka-console-producer.sh --broker-list localhost:9092 --topic test-partitions --property parse.key=true < /home/test_partitions.csv"
