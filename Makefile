...
get-streamsets-libs: install-streamsets-requirements
	...
	curl -L https://github.com/anodot/anodot-sdc-stage/releases/download/v2.0.0/anodot-2.0.0.tar.gz -o /tmp/sdc.tar.gz && tar xvfz /tmp/sdc.tar.gz -C containers/streamsets/lib
