...
setup-all: clean-docker-volumes run-all-dev sleep setup-elastic setup-kafka

setup-all-build: clean-docker-volumes build-all-dev sleep setup-elastic setup-kafka

run-all-dev: clean-docker-volumes
