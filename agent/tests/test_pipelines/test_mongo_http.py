...
class TestMongo(TestPipelineBase):
    ...
    params = {
        'test_start': [{'name': 'test_value_const'}, {'name': 'test_timestamp_ms'},
                       ...
                       {'name': 'test_mongo_file_short'}, {'name': 'test_mongo_file_full'},
                       {'name': 'test_mongo_enc_file_short'}],
        ...
        'test_delete_pipeline': [{'name': 'test_value_const'}, {'name': 'test_timestamp_ms'},
                                 ...
                                 {'name': 'test_mongo_file_short'}, {'name': 'test_mongo_file_full'},
                                 {'name': 'test_mongo_enc_file_short'}],
        'test_source_delete': [{'name': 'test_mongo'}, {'name': 'test_mongo_1'}, {'name': 'test_mongo_enc'}]
    }
