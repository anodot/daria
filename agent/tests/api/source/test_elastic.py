class TestElastic:
    params = {
        'test_create': [{
            ...
            'er': b'[{"config":{"conf.httpUris":["http://es:9200"],"conf.index":"test","conf.initialOffset":"now-3d/d","conf.isIncrementalMode":false,"conf.offsetField":"timestamp","conf.queryInterval":"seconds","conf.query":null},"name":"elastic","type":"elastic"}]\n'
        }],
        'test_edit': [{
            'data': [{
                'name': 'elastic',
            ...
            'er': b'[{"config":{"conf.httpUris":["http://es:9201"],"conf.index":"test1","conf.initialOffset":"now-3d/d","conf.isIncrementalMode":false,"conf.offsetField":"timestamp","conf.queryInterval":"seconds","conf.query":null},"name":"elastic","type":"elastic"}]\n'
        }]
    }
