class TestJdbc:
    params = {
        'test_create': [{
            ...
            'er': b'[{"config":{"conf.pagination.query_interval":10,"hikariConfigBean.connectionString":"jdbc:mysql://root@mysql:3306/test","hikariConfigBean.password":"","hikariConfigBean.username":""},"name":"mysql","type":"mysql"}]\n'
        }],
        'test_edit': [{
            'data': [{
                'name': 'mysql',
            ...
            'er': b'[{"config":{"conf.pagination.query_interval":5,"hikariConfigBean.connectionString":"jdbc:mysql://root@mysql:3306/test","hikariConfigBean.password":"","hikariConfigBean.username":""},"name":"mysql","type":"mysql"}]\n'
        }]
    }
