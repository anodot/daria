...
STREAMSETS_MAX_RETRY_ATTEMPTS = int(os.environ.get('STREAMSETS_MAX_RETRY_ATTEMPTS', -1))
STREAMSETS_NOTIFY_AFTER_RETRY_ATTEMPTS = int(os.environ.get('STREAMSETS_NOTIFY_AFTER_RETRY_ATTEMPTS', 5))
STREAMSETS_NOTIFY_RESET_AFTER_MIN = int(os.environ.get('STREAMSETS_NOTIFY_RESET_AFTER_MIN', 60))
...
AGENT_MONITORING_ENDPOINT = os.environ.get(
    'AGENT_MONITORING_ENDPOINT', f'http://localhost:{_agent_listen_port}/monitoring'
)
...
PIPELINE_REQUEST_RETRIES = os.environ.get('PIPELINE_REQUEST_RETRIES', 3)
PIPELINE_RETRY_SLEEP_TIME_SECONDS = os.environ.get('PIPELINE_RETRY_SLEEP_TIME_SECONDS', 10)

SNMP_DEFAULT_PORT = os.environ.get('SNMP_DEFAULT_PORT', 161)

IGNORE_REQUEST_EXCEPTIONS = os.environ.get('IGNORE_REQUEST_EXCEPTIONS', 'false') == 'true'
