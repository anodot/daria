...
class SchemaConfigLoader(ConfigLoader):
    ...
    def _get_config_file(cls, pipeline: Pipeline) -> str:
        return {
            ...
            source.TYPE_MSSQL: 'jdbc_schema.json',
...
class TestPipelineConfigLoader(ConfigLoader):
    ...
    def _get_config_file(cls, pipeline: Pipeline) -> str:
        return {
            ...
            source.TYPE_DRUID: 'test_jdbc_pdsf4587.json',
            source.TYPE_ELASTIC: 'test_elastic_asdfs3245.json',
            source.TYPE_HTTP: 'test_http.json',
            source.TYPE_IMPALA: 'test_jdbc_pdsf4587.json',
            ...
            source.TYPE_MSSQL: 'test_jdbc_pdsf4587.json',
