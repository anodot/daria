...
def _filter_without_cli(sources: list) -> list:
    with_cli = [source.TYPE_CACTI, source.TYPE_CLICKHOUSE, source.TYPE_DIRECTORY, source.TYPE_ELASTIC,
                source.TYPE_INFLUX, source.TYPE_KAFKA, source.TYPE_MONGO, source.TYPE_MYSQL, source.TYPE_POSTGRES,
                source.TYPE_SAGE, source.TYPE_SPLUNK, source.TYPE_SOLARWINDS, source.TYPE_VICTORIA, source.TYPE_ZABBIX]
