...
def main():
    ...
    for pipeline_ in pipelines:
        try:
            ...
            should_send_no_data_notification = pipeline.manager.should_send_no_data_error_notification(pipeline_)
            print(should_send_no_data_notification)
            should_send_error_notification = False
